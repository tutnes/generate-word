...
/*    [XmlRoot(ElementName = "technology")]
    ...
    public class Color
    {
        ...
        public string Color.blue { get; set; }
        [XmlAttribute(AttributeName = "color.red")]
        public string Color.red { get; set; }
        [XmlAttribute(AttributeName = "color.green")]
        public string Color.green { get; set; }
    }
    ...
    public class Measure
    {
        ...
        public string Com.dynatrace.diagnostics.global.processperformancemeasureconfig { get; set; }
    ...
    public class Thresholds
    {
        ...
        public string Threshold.upper.severe { get; set; }
        [XmlAttribute(AttributeName = "threshold.lower.severe")]
        public string Threshold.lower.severe { get; set; }
    }
